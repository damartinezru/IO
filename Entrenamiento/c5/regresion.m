function createfigure(X1, YMatrix1, X2, Y1, X3, YMatrix2, X4, X5, YMatrix3, X6, X7, YMatrix4, X8)
%CREATEFIGURE(X1, YMatrix1, X2, Y1, X3, YMatrix2, X4, X5, YMatrix3, X6, X7, YMatrix4, X8)
%  X1:  vector of x data
...
%  Auto-generated by MATLAB on 06-Mar-2019 20:16:22
...
% Create ylabel
ylabel('Output ~= 0.89*Target + 0.031','FontWeight','bold','FontSize',12);

% Create xlabel
xlabel('Target','FontWeight','bold','FontSize',12);

% Create title
title('Training: R=0.97455','FontWeight','bold','FontSize',12);

% Uncomment the following line to preserve the X-limits of the axes
% xlim(subplot1,[0.03 1.08918738758912]);
% Uncomment the following line to preserve the Y-limits of the axes
% ylim(subplot1,[0.03 1.08918738758912]);
box(subplot1,'on');
...
% Create ylabel
ylabel('Output ~= 0.78*Target + 0.058','FontWeight','bold','FontSize',12);
...
% Uncomment the following line to preserve the X-limits of the axes
% xlim(subplot2,[0.102378375117279 1.33]);
% Uncomment the following line to preserve the Y-limits of the axes
% ylim(subplot2,[0.102378375117279 1.33]);
box(subplot2,'on');
...
% Create ylabel
ylabel('Output ~= 2.1*Target + -0.25','FontWeight','bold','FontSize',12);
...
% Uncomment the following line to preserve the X-limits of the axes
% xlim(subplot3,[0.102378375117279 1.08918738758912]);
% Uncomment the following line to preserve the Y-limits of the axes
% ylim(subplot3,[0.102378375117279 1.08918738758912]);
box(subplot3,'on');
...
% Create multiple lines using matrix input to plot
plot4 = plot(X7,YMatrix4,'Parent',subplot4);
set(plot4(1),'DisplayName','Y = T','LineStyle',':','Color',[0 0 0]);
set(plot4(2),'DisplayName','Fit','LineWidth',2,'Color',[0.4 0.4 0.4]);

% Create plot
plot(X8,Y1,'Parent',subplot4,'DisplayName','Data','Marker','o',...
    'LineStyle','none',...
    'Color',[0 0 0]);

% Create ylabel
ylabel('Output ~= 0.84*Target + 0.067','FontWeight','bold','FontSize',12);

% Create xlabel
xlabel('Target','FontWeight','bold','FontSize',12);

% Create title
title('All: R=0.93793','FontWeight','bold','FontSize',12);

% Uncomment the following line to preserve the X-limits of the axes
% xlim(subplot4,[0.03 1.33]);
% Uncomment the following line to preserve the Y-limits of the axes
% ylim(subplot4,[0.03 1.33]);
box(subplot4,'on');
