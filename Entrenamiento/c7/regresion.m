...
%  Auto-generated by MATLAB on 06-Mar-2019 20:23:39
...
% Create ylabel
ylabel('Output ~= 0.99*Target + 0.0056','FontWeight','bold','FontSize',12);

% Create xlabel
xlabel('Target','FontWeight','bold','FontSize',12);

% Create title
title('Training: R=0.99365','FontWeight','bold','FontSize',12);

% Uncomment the following line to preserve the X-limits of the axes
% xlim(subplot1,[0.08 1.95]);
% Uncomment the following line to preserve the Y-limits of the axes
% ylim(subplot1,[0.08 1.95]);
box(subplot1,'on');
...
% Create ylabel
ylabel('Output ~= 1.9*Target + 0.1','FontWeight','bold','FontSize',12);
...
% Uncomment the following line to preserve the X-limits of the axes
% xlim(subplot2,[0.04 1.926070810342]);
% Uncomment the following line to preserve the Y-limits of the axes
% ylim(subplot2,[0.04 1.926070810342]);
box(subplot2,'on');
...
% Create ylabel
ylabel('Output ~= 5.4*Target + -1.7','FontWeight','bold','FontSize',12);
...
% Uncomment the following line to preserve the X-limits of the axes
% xlim(subplot3,[0.0857298413899001 1.926070810342]);
% Uncomment the following line to preserve the Y-limits of the axes
% ylim(subplot3,[0.0857298413899001 1.926070810342]);
box(subplot3,'on');
...
% Create ylabel
ylabel('Output ~= 0.96*Target + 0.09','FontWeight','bold','FontSize',12);

% Create xlabel
xlabel('Target','FontWeight','bold','FontSize',12);

% Create title
title('All: R=0.93031','FontWeight','bold','FontSize',12);

% Uncomment the following line to preserve the X-limits of the axes
% xlim(subplot4,[0.04 1.95]);
% Uncomment the following line to preserve the Y-limits of the axes
% ylim(subplot4,[0.04 1.95]);
box(subplot4,'on');
