...
%  Auto-generated by MATLAB on 06-Mar-2019 20:02:20
...
% Create ylabel
ylabel('Output ~= 0.88*Target + 0.032','FontWeight','bold','FontSize',12);

% Create xlabel
xlabel('Target','FontWeight','bold','FontSize',12);

% Create title
title('Training: R=0.93128','FontWeight','bold','FontSize',12);

% Uncomment the following line to preserve the X-limits of the axes
% xlim(subplot1,[0.03 0.97]);
% Uncomment the following line to preserve the Y-limits of the axes
% ylim(subplot1,[0.03 0.97]);
box(subplot1,'on');
...
% Create ylabel
ylabel('Output ~= 0.85*Target + 0.089','FontWeight','bold','FontSize',12);
...
% Uncomment the following line to preserve the X-limits of the axes
% xlim(subplot2,[0.0358850429470398 0.893021197261831]);
% Uncomment the following line to preserve the Y-limits of the axes
% ylim(subplot2,[0.0358850429470398 0.893021197261831]);
box(subplot2,'on');
...
% Create ylabel
ylabel('Output ~= 0.71*Target + 0.071','FontWeight','bold','FontSize',12);
...
% Uncomment the following line to preserve the X-limits of the axes
% xlim(subplot3,[0.0358850429470398 0.893021197261831]);
% Uncomment the following line to preserve the Y-limits of the axes
% ylim(subplot3,[0.0358850429470398 0.893021197261831]);
box(subplot3,'on');
...
% Create ylabel
ylabel('Output ~= 0.89*Target + 0.04','FontWeight','bold','FontSize',12);

% Create xlabel
xlabel('Target','FontWeight','bold','FontSize',12);

% Create title
title('All: R=0.9566','FontWeight','bold','FontSize',12);

% Uncomment the following line to preserve the X-limits of the axes
% xlim(subplot4,[0.03 0.97]);
% Uncomment the following line to preserve the Y-limits of the axes
% ylim(subplot4,[0.03 0.97]);
box(subplot4,'on');
