...
%  Auto-generated by MATLAB on 06-Mar-2019 20:27:55
...
% Create ylabel
ylabel('Output ~= 0.47*Target + 0.11','FontWeight','bold','FontSize',12);

% Create xlabel
xlabel('Target','FontWeight','bold','FontSize',12);

% Create title
title('Training: R=0.66654','FontWeight','bold','FontSize',12);

% Uncomment the following line to preserve the X-limits of the axes
% xlim(subplot1,[0.07 0.43]);
% Uncomment the following line to preserve the Y-limits of the axes
% ylim(subplot1,[0.07 0.43]);
box(subplot1,'on');
...
% Create ylabel
ylabel('Output ~= 0.074*Target + 0.21','FontWeight','bold','FontSize',12);
...
% Uncomment the following line to preserve the X-limits of the axes
% xlim(subplot2,[0.131884237139051 0.91]);
% Uncomment the following line to preserve the Y-limits of the axes
% ylim(subplot2,[0.131884237139051 0.91]);
box(subplot2,'on');
...
% Create ylabel
ylabel('Output ~= 0.23*Target + 0.2','FontWeight','bold','FontSize',12);
...
% Uncomment the following line to preserve the X-limits of the axes
% xlim(subplot3,[0.022 0.96]);
% Uncomment the following line to preserve the Y-limits of the axes
% ylim(subplot3,[0.022 0.96]);
box(subplot3,'on');
...
% Create ylabel
ylabel('Output ~= 0.21*Target + 0.17','FontWeight','bold','FontSize',12);

% Create xlabel
xlabel('Target','FontWeight','bold','FontSize',12);

% Create title
title('All: R=0.70639','FontWeight','bold','FontSize',12);

% Uncomment the following line to preserve the X-limits of the axes
% xlim(subplot4,[0.022 0.96]);
% Uncomment the following line to preserve the Y-limits of the axes
% ylim(subplot4,[0.022 0.96]);
box(subplot4,'on');
