...
%  Auto-generated by MATLAB on 06-Mar-2019 20:29:50
...
% Create ylabel
ylabel('Output ~= 0.97*Target + 0.014','FontWeight','bold','FontSize',12);

% Create xlabel
xlabel('Target','FontWeight','bold','FontSize',12);

% Create title
title('Training: R=0.98466','FontWeight','bold','FontSize',12);

% Uncomment the following line to preserve the X-limits of the axes
% xlim(subplot1,[0.04 0.98271847204659]);
% Uncomment the following line to preserve the Y-limits of the axes
% ylim(subplot1,[0.04 0.98271847204659]);
box(subplot1,'on');
...
% Create ylabel
ylabel('Output ~= 5.1*Target + -0.76','FontWeight','bold','FontSize',12);
...
% Uncomment the following line to preserve the X-limits of the axes
% xlim(subplot2,[0.0755066147848196 0.98271847204659]);
% Uncomment the following line to preserve the Y-limits of the axes
% ylim(subplot2,[0.0755066147848196 0.98271847204659]);
box(subplot2,'on');
...
% Create ylabel
ylabel('Output ~= 1.2*Target + -0.06','FontWeight','bold','FontSize',12);
...
% Uncomment the following line to preserve the X-limits of the axes
% xlim(subplot3,[0.0755066147848196 0.98271847204659]);
% Uncomment the following line to preserve the Y-limits of the axes
% ylim(subplot3,[0.0755066147848196 0.98271847204659]);
box(subplot3,'on');
...
% Create ylabel
ylabel('Output ~= 0.98*Target + 0.0028','FontWeight','bold','FontSize',12);

% Create xlabel
xlabel('Target','FontWeight','bold','FontSize',12);

% Create title
title('All: R=0.98273','FontWeight','bold','FontSize',12);

% Uncomment the following line to preserve the X-limits of the axes
% xlim(subplot4,[0.04 0.98271847204659]);
% Uncomment the following line to preserve the Y-limits of the axes
% ylim(subplot4,[0.04 0.98271847204659]);
box(subplot4,'on');
