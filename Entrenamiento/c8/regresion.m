...
%  Auto-generated by MATLAB on 06-Mar-2019 20:25:27
...
% Create ylabel
ylabel('Output ~= 0.96*Target + 0.014','FontWeight','bold','FontSize',12);

% Create xlabel
xlabel('Target','FontWeight','bold','FontSize',12);

% Create title
title('Training: R=0.98131','FontWeight','bold','FontSize',12);

% Uncomment the following line to preserve the X-limits of the axes
% xlim(subplot1,[0.00615198137713104 1.21]);
% Uncomment the following line to preserve the Y-limits of the axes
% ylim(subplot1,[0.00615198137713104 1.21]);
box(subplot1,'on');
...
% Create ylabel
ylabel('Output ~= 0.66*Target + 0.057','FontWeight','bold','FontSize',12);
...
% Uncomment the following line to preserve the X-limits of the axes
% xlim(subplot2,[0.00615198137713104 1.192719628546]);
% Uncomment the following line to preserve the Y-limits of the axes
% ylim(subplot2,[0.00615198137713104 1.192719628546]);
box(subplot2,'on');
...
% Create plot
plot(X5,Y1,'Parent',subplot3,'DisplayName','Data','Marker','o',...
    'LineStyle','none',...
    'Color',[0 0 0]);

% Create ylabel
ylabel('Output ~= -2.4*Target + 1.1','FontWeight','bold','FontSize',12);
...
% Uncomment the following line to preserve the X-limits of the axes
% xlim(subplot3,[0.00615198137713104 1.192719628546]);
% Uncomment the following line to preserve the Y-limits of the axes
% ylim(subplot3,[0.00615198137713104 1.192719628546]);
box(subplot3,'on');
...
% Create plot
plot(X6,Y1,'Parent',subplot4,'DisplayName','Data','Marker','o',...
    'LineStyle','none',...
    'Color',[0 0 0]);

% Create ylabel
ylabel('Output ~= 0.9*Target + 0.016','FontWeight','bold','FontSize',12);

% Create xlabel
xlabel('Target','FontWeight','bold','FontSize',12);

% Create title
title('All: R=0.8742','FontWeight','bold','FontSize',12);

% Uncomment the following line to preserve the X-limits of the axes
% xlim(subplot4,[0.00615198137713104 1.21]);
% Uncomment the following line to preserve the Y-limits of the axes
% ylim(subplot4,[0.00615198137713104 1.21]);
box(subplot4,'on');
